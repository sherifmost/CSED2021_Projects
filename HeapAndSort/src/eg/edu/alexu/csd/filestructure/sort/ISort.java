...
public interface ISort<T extends Comparable<T>> {
	 ...
	 * sorting, and before you empty it. * Runs in O(n lg n) time * @param unordered
	 * unordered elements * @return heap structure used
	 */
	 ...
	 * in-place * @param unordered unordered elements
	 */
